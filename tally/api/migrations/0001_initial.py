...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_client', (
            ...
            ('api_key', self.gf('django.db.models.fields.TextField')(unique=True, blank=True)),
        ...
        db.send_create_signal('api', ['Counter'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('api_counter')


    models = {
        'api.client': {
            'Meta': {'object_name': 'Client'},
            'api_key': ('django.db.models.fields.TextField', [], {'unique': 'True', 'blank': 'True'}),
        ...
        'api.counter': {
            'Meta': {'ordering': "['id']", 'object_name': 'Counter'},
